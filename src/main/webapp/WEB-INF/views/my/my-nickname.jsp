...
<script src="${rootPath}/static/js/nicknameCheck.js"></script>
...
<body>
	...
	<nav class="navbar fixed-top navbar-dark bg-primary">
		...
		<span class="navbar-title">닉네임 변경</span>
	</nav>
	<!-- // Navigation -->
	<hr class="mt-0 mb-0" />
	...
	<div class="container nopadding mt-4">
		<div class="row no-gutters align-items-center">
			<div class="col-9 pl-2">사용할 닉네임을 입력해주세요.</div>
			<div class="col-3 text-right pr-2">
				<small class="grey">4 / 7</small>
			</div>
		</div>
		<div class="card-round-box-grey mt-3">
			<form class="form-line mt-3 form-nickname" method="POST">
				<div class="form-group">
					<label for="inputNickname" class="sr-only">닉네임</label>
					<!--value : myController 안에 my_nickname 메서드에서 처리  -->
					<input name="nickname" type="text" class="form-control is-invalid" id="inputNickname" placeholder="닉네임" value="${USER.nickname}" maxlength='8'>
					<div class="w3-container error"></div>
				</div>
				<button type="button" class="btn btn-primary btn-lg btn-block btn-nickname">변경하기</button>
			</form>
		</div>
	</div>
