...
<body>
		...
		<div class="container nopadding mt-4">
			<div class="row no-gutters align-items-center">
				...
				<div class="col-3 text-right pr-2"><small class="grey">4 / 7</small></div>
			</div>
			<div class="card-round-box-grey mt-3">
				<form class="form-line mt-3" method="POST">
					<div class="form-group">
						<label for="inputNickname" class="sr-only">닉네임</label>
						 <!--value : myController 안에 my_nickname 메서드에서 처리  -->
						<input name="nickname" type="text" class="form-control is-invalid" id="inputNickname" placeholder="닉네임" value="${USER.nickname}">
					</div>
			<button  type="submit" class="btn btn-primary btn-lg btn-block">변경하기</button>
				</form>
			</div>
		</div>
