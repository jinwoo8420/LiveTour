		...
		<div class="container nopadding">		
			<div class="pt-0">
				...
				<div class="row no-gutters align-items-center">
					<div class="col-11 pl-2"><strong class="text-primary">[공지]</strong> 고객센터 운영시간 변경 안내<br/><small class="grey">2022.06.20</small></div>
					<div class="col-1 text-right pl-1"><img src="${rootPath}/static/img/svg/cal-arrow-right.svg" alt=""/></div>
				</div>
				</a>
				<hr class="full mt-3 mb-3"/>
				<a href="${rootPath}/my/notice-view">
				<div class="row no-gutters align-items-center">
					<div class="col-11 pl-2"><strong class="text-primary">[이벤트]</strong> 라이브투어 런칭기념 경품 이벤트 당첨자 안내<br/><small class="grey">2022.06.20</small></div>
					<div class="col-1 text-right pl-1"><img src="${rootPath}/static/img/svg/cal-arrow-right.svg" alt=""/></div>
				</div>
				</a>
				<hr class="full mt-3 mb-3"/>
