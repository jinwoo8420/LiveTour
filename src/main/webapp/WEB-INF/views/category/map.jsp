...
<body>
		...
		<nav class="navbar fixed-top navbar-dark bg-primary">
			...
			<span class="navbar-title">지도</span>
		...
		<div class="container nopadding">
			<div class="mapwrap d-flex align-items-center">
				<ul class="marker-list">								
					<li class="active"><a href="#none"><figure class="bg"><span class="play-live"></span></figure><span>라이브</span></a></li>
					<li class="active"><a href="#none"><figure class="bg1"><img src="${rootPath}/static/img/svg/marker-tour.svg" alt="" class="vam" /></figure><span>관광지</span></a></li>
					<li class="active"><a href="#none"><figure class="bg2"><img src="${rootPath}/static/img/svg/marker-restaurant.svg" alt="" class="vam" /></figure><span>맛집</span></a></li>
					<li class="active"><a href="#none"><figure class="bg3"><img src="${rootPath}/static/img/svg/marker-lodge.svg" alt="" class="vam" /></figure><span>숙박</span></a></li>
				</ul>
				<div id="map">
					<!-- 마커아이콘 -->
					...
					<img src="${rootPath}/static/img/svg/marker-me.svg" alt="" class="pointer-me" style="top:50%; left:50%;"/>
					<!-- / 마커아이콘-->		
		...
		<!-- Modal 정보 -->
		<div class="modal show modal-full-btm radius" id="infoModal" tabindex="-1" aria-labelledby="infoModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-body">
							<a href="#none" data-dismiss="modal" class="float-top-right"><img src="${rootPath}/static/img/svg/icon_close_grey.svg" alt=""/></a>
							<a href="${rootPath}/detail/detail">
								<div class="card card-sm">
									<div class="row no-gutters d-flex align-items-center">
										<div class="cardimgWrap">
											<span class="play-live"></span>
											<img src="${rootPath}/static/img/sample/photob1.jpg" class="img-fluid" alt=""/>											
										</div>
										<div class="cardInfoWrap">
											<div class="card-body">
												<h6>남이섬 남이나루</h6>
												<p><strong>강원도 춘천시 남산면 방하리 198-2</strong><br/>내 위치에서 721km</p>
												<a href="#none" class="btn btn-dark btn-round btn-xs mt-2"><i class="bi bi-arrow-90deg-right mr-1"></i>길안내</a>
											</div>
										</div>
									</div>
								</div>	
		...
		<div class="tab_barwrap fixed-bottom">
			<div class="container nopadding">
				<nav class="nav nav-pills nav-tab nav-justified">
					...
					<a class="nav-link active" href="${rootPath}/category/map"><figure class="tab_map"></figure>지도</a>
