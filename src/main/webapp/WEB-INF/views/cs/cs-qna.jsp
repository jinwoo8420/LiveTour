...
<body>
	...
	<nav class="nav nav-pills nav-menu nav-justified">
		<a class="nav-link" href="${rootPath}/cs/cs-faq">자주하는 질문</a> <a
			class="nav-link active" href="${rootPath}/cs/cs-qna">1:1문의</a> <a
			class="nav-link" href="${rootPath}/cs/cs-apply">제휴요청</a>
	</nav>
	<!--// 탭메뉴 -->

	<!-- 탭메뉴 -->
	<nav class="nav nav-pills nav-menu nav-justified">
		<a class="nav-link active" href="${rootPath}/cs/cs-qna">문의하기</a> <a
			class="nav-link" href="${rootPath}/cs/cs-qna-list">문의내역</a>
	</nav>
	<!--// 탭메뉴 -->
		...
		<form class="qnaForm" method="POST">
				...
				<div class="col-xs-12 col-sm-12 apply ">
					...
					<div class="form-group">
						<div class="input-group">
							<label class="input-group-addon">카테고리<strong
								class="required"></strong></label> <select class="form-control"
								id="selCategory" name="Category">
					...
					<div class="form-group">
						<div class="input-group">
							<label class="input-text-addon" for="inputMemo">내용<strong
								class="required"></strong></label>
							<textarea name="Memo" class="form-control" rows="9"
								placeholder="내용을 작성하세요" id="inputMemo"></textarea>
						</div>
					</div>

					<label class="control radio mt-3 mr-3"> <input name="tel"
						type="radio" class="add-contrast radio_tel" data-role="collar">
						<span class="control-indicator control-tel"></span><span
						class="control-text">전화번호</span>
					</label> <label class="control radio mt-3"> <input name="email"
						type="radio" class="add-contrast radio_email" data-role="collar">
						<span class="control-indicator control-email"></span><span
						class="control-text">이메일</span>
					</label>

					<div class="form-group">
						<div class="input-group">
							<label class="input-group-addon" for="inputRocal">연락처<strong
								class="required"></strong></label> <input name="Tel" type="number"
					...
					<div class="form-group">
						<div class="input-group">
							<label class="input-group-addon" for="inputBizName">첨부파일<strong
								class="required"></strong></label> <input name="Bizname" type="file"
								class="form-control" id="inputBizName" placeholder="파일을 첨부하세요.">
						</div>
					</div>
			...
			<div class="fixed-bottom">
				<div class="row no-gutters">
					<div class="col-12">
						<button type="button"
							class="btn_qna btn btn-primary btn-lg btn-block"
							data-toggle="modal" data-target="#inputModal">문의하기</button>
					</div>
				</div>
			</div>
			<!--// 하단버튼 -->
