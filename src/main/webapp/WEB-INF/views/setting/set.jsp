		...
		<div class="container nopadding mt-0">		
			<div class="pt-0">
				...
				<div class="row no-gutters align-items-center">
					<div class="col-3 pl-2">프로필 관리</div>
				...
				<a href="${rootPath}/setting/set-alarm">
				<div class="row no-gutters align-items-center">
				...
				<hr class="full mt-3 mb-3"/>
				<a href="${rootPath}/setting/set-vod">
				<div class="row no-gutters align-items-center">
				...
				<hr class="full mt-3 mb-3"/>
				<a href="${rootPath}/setting/policy">
				<div class="row no-gutters align-items-center">
				...
				<hr class="full mt-3 mb-3"/>
				<a href="${rootPath}/setting/memout">
				<div class="row no-gutters align-items-center">
					<div class="col-3 pl-2">탈퇴하기</div>
					<div class="col-8 text-right"></div>
					<div class="col-1 text-right pl-1"><img src="${rootPath}/static/img/svg/cal-arrow-right.svg" alt=""/></div>
				</div>
				</a>
				<hr class="full mt-3 mb-3"/>
				<a href="${rootPath}/user/login">
				<div class="row no-gutters align-items-center">
