			...
			<div class="mt-4">
				<form class="form-line mt-	1">
					<div class="form-group">
						<label for="inputName" class="sr-only">새 비밀번호</label>
						<input type="email" class="form-control" id="inputName" placeholder="새 비밀번호 (영문/숫자/특수문자 조합, 8~15자 이내)" value="">
						<a href="#none" class="text-link text-primary">발송</a>
					</div>
					<div class="form-group">
						<label for="inputPhone" class="sr-only">새 비밀번호 확인</label>
						<input type="email" class="form-control" id="inputPhone" placeholder="새 비밀번호 확인" value="">
					</div>
					<div class="form-group pt-2">
						<a href="${rootPath}/index" class="btn btn-primary btn-lg btn-block">비밀번호 변경</a>
						<!-- <a href="findpw_reset" class="btn btn-grey btn-lg btn-block">비밀번호 변경</a> -->
					</div>
				</form>
			</div>
		</div>
