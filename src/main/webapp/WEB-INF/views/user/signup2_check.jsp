			...
			<div>
				<form class="form-line mt-3">
					<div class="form-group">
						...
						<input type="email" class="form-control is-invalid" id="inputName" placeholder="이메일" value="gildong@gmail.com">
						<p class="text-muted"><small class="red">이메일 주소 형식을 확인해 주세요.</small></p>
					</div>
					<div class="form-group">
						<label for="inputPassword" class="sr-only">비밀번호</label>
						<input type="password" class="form-control is-invalid" id="inputPassword" placeholder="비밀번호 (영문/숫자/특수문자 조합, 8~15자 이내)" value="password">
						<p class="text-muted"><small class="red">공백을 제외한 8자 이상 영문/숫자/특수문자 조합으로 설정해 주세요.</small></p>
					</div>
					<div class="form-group">
						<label for="inputPasswordC" class="sr-only">비밀번호 확인</label>
						<input type="password" class="form-control is-invalid" id="inputPasswordC" placeholder="비밀번호 확인" value="password">
						<p class="text-muted"><small class="red">비밀번호가 일치하지 않습니다.</small></p>
					</div>
					<div class="form-group">
						<label for="inputNickname" class="sr-only">닉네임</label>
						<input type="email" class="form-control is-invalid" id="inputNickname" placeholder="닉네임" value="바다조아">
						<p class="text-muted"><small class="red">닉네임은 2자 이상 7자 이하로 입력해 주세요.<br/>중복되는 닉네임이 있습니다.</small></p>
					</div>
					<div class="form-group pt-2">
						<a href="${rootPath}/user/signup2_confirm" class="btn btn-grey btn-lg btn-block">가입하기</a>
					</div>
				</form>
			</div>
		</div>
