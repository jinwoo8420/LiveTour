...
<script src="${rootPath}/static/js/join.js?2022-08-02-001"></script>
...
<body>
	...
	<nav class="navbar fixed-top navbar-dark bg-primary">
		...
		</a> <span class="navbar-title">회원가입</span>
	</nav>
	<!-- // Navigation -->
		...
		<div>
			<form class="form-line mt-3 join" method="POST">
				<div class="form-group">
					<label for="inputName" class="sr-only">이메일</label> <input
						name="username" type="email" class="form-control" id="inputName"
				...
				<div class="form-group">
					<label for="inputPassword" class="sr-only">비밀번호</label> <input
						...
						id="inputPassword" placeholder="비밀번호 (영문/숫자/특수문자 조합, 8~15자 이내)"
						value="">
					<div class="w3-container error"></div>
				</div>
				<div class="form-group">
					<label for="inputPasswordC" class="sr-only">비밀번호 확인</label> <input
						type="password" class="form-control" id="inputPasswordC"
				...
				<div class="form-group">
					<label for="inputNickname" class="sr-only">닉네임</label> <input
						...
						id="inputNickname" placeholder="닉네임" value="" maxlength='8'>
					<div class="w3-container error"></div>
				</div>
				<div class="form-group pt-2">
					<button
						<%-- onclick="location.href = '${rootPath}/user/signup2_check';" --%>
						class="btn btn-grey btn-lg btn-block"
						id="btn-join" type="button">가입하기</button>
