			...
			<div class="mt-4">
				<form class="form-line mt-	1">
					...
					<div class="form-group">
						...
						<input type="email" class="form-control" id="inputPhone" placeholder="인증번호 6자리를 입력해 주세요." value="">
					</div>
					<div class="form-group pt-2">
						<!-- <a href="findpw_reset" class="btn btn-primary btn-lg btn-block">비밀번호 찾기</a> -->
						<a href="${rootPath}/user/findpw_auth" class="btn btn-grey btn-lg btn-block">비밀번호 찾기</a>
					</div>
				</form>
			</div>
		</div>
